...
$redirectURL = 'linkmultifolder.php';
    ...
    if(isset($_POST['userMediaSubmit']) && isset($_FILES['image_file'])){
        ...
        if($error === 0){
            if($img_size > 125000){
                ...
                header("Location: addEditMedia.php?error=$em");
            } else {
        ...
        if(!empty($image) && !empty($url_name) && !empty($category) && !empty($type_name)){
            if(!empty($id)){
                ...
                if($update){
                    ...
                    // Set redirect url
                    $redirectURL = 'addEditMedia.php'.$idStr;
                }
            }else{
                // Insert data
    ...
    $_SESSION['sessData'] = $sessData;
        ...
        header("Location: addEditMedia.php");
    }
