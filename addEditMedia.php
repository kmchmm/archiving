...
<div class="panel">
    ...
    <div class="panel-heading heavier"><?php echo $actionLabel; ?> USER <a href="linkmultifolder.php"> <i class='bx bx-arrow-back'></i></a></div>
        <form method="post" action="mediaAction.php" class="form" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <input type="submit" name="userMediaSubmit" class="input_button bolder" value="SUBMIT"/>
        </form>
    </div>
